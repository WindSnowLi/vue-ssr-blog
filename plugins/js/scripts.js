...
(function($) {
  ...
  jQuery('img.svg').each(function() {
    ...
    jQuery.get(imgURL, function(data) {
      ...
      let $svg = jQuery(data).find('svg') // Add replaced image's ID to the new SVG
  ...
  /* 03: Searh Box
  ==============================================*/
  const searchOpen = $('.mobile-nav-menu .search-toggle-open')
  const searchClose = $('.mobile-nav-menu .search-toggle-close')
  ...
  const subToggle = function subToggle() {
